            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h5 class="pl-3">CREATE TRANSACTION</h5>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <legend><small><b>User Information</b></small>
                                                                        </legend>
                                                                        <div class="form-group row">
                                                                            <label for="user_id"
                                                                                class="col-sm-3 col-form-label"
                                                                                style="font-size:12px">User
                                                                                Name</label>
                                                                            <div class="col-sm-9">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="branch"
                                                                                class="col-sm-3 col-form-label"
                                                                                style="font-size:12px">Gender</label>
                                                                            <div class="col-sm-9">
                                                                                <input type="text"
                                                                                    class="form-control form-control-sm"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label for="department"
                                                                                class="col-sm-3 col-form-label"
                                                                                style="font-size:12px">Department</label>
                                                                            <div class="col-sm-9">
                                                                                <input type="text"
                                                                                    class="form-control form-control-sm"
                                                                                    id="department"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="w-100">
                                                                            <img style="width: 80%;"
                                                                                class=" img-thumbnail"
                                                                                src="{{asset('images/none.jpg')}}"
                                                                                id="previewuser_image" alt="none.jpg"
                                                                                srcset="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="condition"
                                                                        ...
                                                                        style="font-size:12px">Condition</label>
                                                                    <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="accessary"
                                                                        class="col-sm-4 col-form-label"
                                                                        style="font-size:12px">Accessary</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inventory_description"
                                                                        class="col-sm-4 col-form-label"
                                                                        style="font-size:12px">ItemDescription</label>
                                                                    <div class="col-sm-8">
                                                                        <textarea type="text"
                                                                            class="form-control form-control-sm"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="usage_description"
                                                                        class="col-sm-4 col-form-label"
                                                                        style="font-size:12px">UsageDescription</label>
                                                                    <div class="col-sm-8">
                                                                        <textarea type="text"
                                                                            class="form-control form-control-sm"
                                                            ...
                                                            <div class="col-md-5 pr-5">
                                                                <div class="form-group row">
                                                                    <label for="preparer_id"
                                                                        class="col-sm-3 col-form-label"
                                                                        style="font-size:12px">Preparer</label>
                                                                    <div class="col-sm-9">
                                                                        <select name="preparer_id" id="preparer_id"
                                                                            class="form-control form-control-sm"
                                                                            required>
                                                                            <option value="" selected>Select Preparer
                                                                            </option>
                                                                            @foreach($users as $user)
                                                                            <option value='{{$user->id}}'>
                                                                                {{$user->name}}
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="reference_id"
                                                                        class="col-sm-3 col-form-label"
                                                                        style="font-size:12px">Reference</label>
                                                                    <div class="col-sm-9">
                                                                        <select name="reference_id" id="reference_id"
                                                                            class="form-control form-control-sm">
                                                                            <option value="" selected>Select Reference
                                                                            </option>
                                                                            @foreach($users as $user)
                                                                            <option value='{{$user->id}}'>
                                                                                {{$user->name}}
                                                                ...
                                                                <div class="user-type">
                                                                    <div class="form-group row">
                                                                        <label for="user_type"
                                                                            class="col-sm-3 col-form-label"
                                                                            style="font-size:12px">Transaction
                                                                            Type</label>
                                                                        <div class="col-sm-9">
                                                                            <select name="user_type" id="user_type"
                                                                                ...
                                                                                <option value='1' selected>Permanent
                                                                                </option>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="start_date"
                                                                        class="col-sm-3 col-form-label"
                                                                        style="font-size:12px">StartDate</label>
                                                                    <div class="col-sm-9">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="expire_date" id="exp_label"
                                                                        class="col-sm-3 col-form-label"
                                                                        style="font-size:12px">ExpireDate</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="datetime-local"
                                                                            class="form-control form-control-sm"
        ...
        $(document).ready(function() {
            ...
            $('#user_id').change(function() {
                ...
                if (id != "") {
                    ...
                    $('#department').val('');
                    $('#position').val('');
                    $('#previewuser_image').attr('src', '{{asset("images/none.jpg")}}');
                    $('#btn_print_transfer').attr('disabled', true);
                    $('#btn_print_transfer').removeClass('btn-success');
                }
            });
