...
<div class="container pt-1">
    <h5><small><b>Add Branch</b></small></h5>
</div>
@endsection
...
@section('content')
<div class="container">
    <form action="{{url('branches/create/submit')}}" method="POST">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                        <input type="text" name="city" value="{{old('group_code')}}"
                            class="form-control form-control-sm rounded" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                        <input type="text" name="country" value="{{old('group_code')}}"
                            class="form-control form-control-sm rounded" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                        <input type="text" name="map_link" value="{{old('group_code')}}"
                            class="form-control form-control-sm rounded" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                        <textarea type="text" name="description"
                            class="form-control form-control-sm rounded">{{old('description')}}</textarea>
                    </div>
                </div>
